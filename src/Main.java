    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 1 -> new AddProduct(inventoryManager, scanner).execute();
                case 2 -> new ViewProducts(inventoryManager).execute();
                case 3 -> new UpdateQuantity(inventoryManager).execute();
                case 4 -> new DeleteProduct(inventoryManager, scanner).execute();
                ...
                case 12 -> new TotalValue(inventoryManager).execute();
